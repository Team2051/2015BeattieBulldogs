...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Reload Manual Back Command", new ReloadManualBackCommand());
        SmartDashboard.putData("Trigger Command", new TriggerCommand());
        SmartDashboard.putData("Reload Manual Forward Command", new ReloadManualForwardCommand());
        SmartDashboard.putData("Light On Command", new LightOnCommand());
        SmartDashboard.putData("Light Off Command", new LightOffCommand());
        SmartDashboard.putData("Reload Auto Forward Command", new ReloadManualForwardCommand());
        SmartDashboard.putData("Reload Auto Back Command", new ReloadManualBackCommand());
