...
public class OI {
	...
	public OI() {
		...
		accessoryButton8.whileHeld(new ReloadManualForwardCommand());
		...
		driveButton1.whenPressed(new FireAndReloadCommand());
		...
		SmartDashboard
				.putData("Collector Up Command", new CollectorUpCommand());
		SmartDashboard.putData("Collector Down Command",
				new CollectorDownCommand());
		SmartDashboard.putData("Collector Intake Command",
				new CollectorIntakeCommand());
		SmartDashboard.putData("Reload Manual Back Command",
				new ReloadManualBackCommand());
		SmartDashboard.putData("Trigger Command", new TriggerCommand());
		SmartDashboard.putData("Reload Manual Forward Command",
				new ReloadManualForwardCommand());
		SmartDashboard.putData("Light On Command", new LightOnCommand());
		SmartDashboard.putData("Light Off Command", new LightOffCommand());
		SmartDashboard.putData("Reload Auto Forward Command",
				new ReloadManualForwardCommand());
		SmartDashboard.putData("Reload Auto Back Command",
				new ReloadManualBackCommand());
		SmartDashboard.putData("Fire And Reload", new FireAndReloadCommand());
