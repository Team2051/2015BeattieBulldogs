...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("Drive System", "Left Front", (Jaguar) driveSystemLeftFront);
        
        driveSystemLeftRear = new Jaguar(1);
        LiveWindow.addActuator("Drive System", "Left Rear", (Jaguar) driveSystemLeftRear);
        
        driveSystemRightFront = new Jaguar(2);
        LiveWindow.addActuator("Drive System", "Right Front", (Jaguar) driveSystemRightFront);
        
        driveSystemRightRear = new Jaguar(0);
        LiveWindow.addActuator("Drive System", "Right Rear", (Jaguar) driveSystemRightRear);
