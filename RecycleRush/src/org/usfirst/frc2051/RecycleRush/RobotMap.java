...
public class RobotMap
{
	...
	public static void init()
	{
		...
		driveSystemMecanum = new RobotDrive(new PIDSpeedController(driveSystemLeftFront, kP, kI, kD, driveSystemLeftFrontEnc), new PIDSpeedController(driveSystemLeftRear, kP, kI, kD, driveSystemLeftRearEnc), new PIDSpeedController(driveSystemRightFront, kP, kI, kD, driveSystemRightFrontEnc), new PIDSpeedController(driveSystemRightRear, kP, kI, kD, driveSystemRightRearEnc));
		...
		LiveWindow.addSensor("Collector", "Collector Opened", collectorCollectorOpened);

		collectorCollectorClosed = new DigitalInput(9);
		LiveWindow.addSensor("Collector", "Collector Closed", collectorCollectorClosed);
