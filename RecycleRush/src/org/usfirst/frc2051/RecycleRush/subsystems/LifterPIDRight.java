...
public class LifterPIDRight extends PIDSubsystem
{
	...
	{
		super("LifterPIDRight", RobotMap.kP, RobotMap.kI, RobotMap.kD);
	...
	protected double returnPIDInput()
	{
		...
		return dARTPositionRight.pidGet() + RobotMap.LIFTER_LEFT_MINUS_RIGHT;
	}
	...
	{
		return ((dARTPositionRight.get() >= RobotMap.LIFTER_MAX) || (dARTPositionRight.get() <= RobotMap.LIFTER_MIN));
	}
}